...
(
    select
         to_date( '01/01/1990', 'mm/dd/yyyy' )                     as start_dt
...
insert overwrite into {environment}_plt_pl_db.main.date_dm
with l_date as
(
...
(
    ...
    select
         cal_dt
        ,{environment}_plt_common_db.util.date_sid_f( cal_dt )                           as dw_date_sid
        ,{environment}_plt_common_db.util.date_sid_f( dateadd( 'day',  -364, cal_dt ) )  as dw_cal_ly_date_sid
