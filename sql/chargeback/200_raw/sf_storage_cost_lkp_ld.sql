...
insert overwrite into {environment}_plt_rl_snowflake_db.account_usage.sf_storage_cost_lkp
select
     cst.cost_amt
    ,cst.active_dt
    ,cst.inactive_dt
...
from
    ( values
          ( 30.00, '2018-01-01', '2019-01-01')
         ,( 23.00, '2019-01-01', '2020-12-01')
         ,( 22.00, '2020-12-01', '2888-01-01')
